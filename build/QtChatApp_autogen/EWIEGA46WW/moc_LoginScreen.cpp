...
Q_CONSTINIT static const qt_meta_stringdata_LoginScreen_t qt_meta_stringdata_LoginScreen = {
    {
        ...
        QT_MOC_LITERAL(37, 4),  // "host"
        QT_MOC_LITERAL(42, 4),  // "port"
        QT_MOC_LITERAL(47, 16)   // "onConnectClicked"
    },
    "LoginScreen",
    "loginRequested",
    "",
...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginRequested((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        ...
        {
            using _t = void (LoginScreen::*)(const QString & , const QString & , int );
...
// SIGNAL 0
void LoginScreen::loginRequested(const QString & _t1, const QString & _t2, int _t3)
{
